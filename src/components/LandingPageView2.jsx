    ...
    >
      ...
      <nav id="navbar" className="fixed top-0 w-full z-50">
        <Card className="rounded-none shadow-sm">
          <CardContent className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
            {/* Left Section: SVG with Overlay Text */}
            <div className="relative">
              ...
              <motion.div
                ...
                <motion.div
                  ...
                  >
                    <circle cx="150" cy="100" r="100" fill="#14213d" opacity="0.9" />
                    <circle cx="280" cy="100" r="100" fill="#d62828" opacity="0.9" />
                    <circle cx="448" cy="100" r="100" fill="#fca311" opacity="0.9" />
                  </svg>
                </motion.div>
              </motion.div>
            ...
            <div className="flex items-center">
              <Tabs>
                <TabsList className="hidden md:flex bg-[#252c42] text-white">
                  <TabsTrigger
                    className="hover:bg-white hover:text-black hover:tracking-wider transition-all duration-500 ease-in-out"
                    value="performances"
      ...
      <div className="w-full max-w-3xl space-y-8">
        ...
        <div className="flex flex-col items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 2, ease: "easeInOut" }}
            className='flex'>
            <span className="material-symbols-outlined text-4xl text-white rounded-full p-1 pt-0 mx-2">
              artist
            </span>
            <motion.h2
              style={{ overflow: "hidden", whiteSpace: "nowrap", display: "inline-block", textAlign: "center" }}
              initial={{ width: 0 }}
              animate={{ width: "100%" }}

              transition={{ duration: 4, ease: "easeInOut" }}
              className="text-4xl font-extrabold text-white play tracking-wider flex items-center justify-center">{artistPage.artistName}
            </motion.h2>
          </motion.div>
          <motion.div
            initial={{ scale: 1 }}
          ...
          <div className="mt-6 flex flex-col flex-wrap justify-center gap-4">
            {musicPlatformLinks.map((link) => (
              <button
                ...
                className="flex items-center p-2 border border-gray-300 rounded-full shadow-md hover:bg-gray-100 transition-all duration-500 hover:scale-105 bg-white text-black"
        ...
        >
          <Card>
            <CardHeader className='bg-[#252c42] text-white rounded-xl h-14 m-4 text-center justify-center'>
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 2, ease: "easeInOut" }}
                ...
                <CardTitle className='text-3xl font-bold'>Music Videos</CardTitle>
              </motion.div>
            </CardHeader>
            <CardContent>
        ...
        <ScrollArea>
          ...
          <motion.div
            ...
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              <h2 className="text-3xl font-bold text-center bg-[#252c42] rounded-xl p-3 text-white mb-6">Performances</h2>
          ...
          <motion.div
            ...
            id="songsSale">
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              <h2 className="text-3xl font-bold text-center bg-[#252c42] rounded-xl p-2 text-white mb-6">Songs for Sale</h2>
          ...
          <motion.div
            ...
            id="merchandise">
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              <h2 className="text-3xl font-bold text-center bg-[#252c42] rounded-xl p-2 text-white mb-6">Merchandise</h2>
          ...
          <motion.div
            ...
            {fanMessages && (
              <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
                <h2 className="text-3xl font-bold text-center bg-[#252c42] rounded-xl p-2 text-white mb-6">Fan Messages</h2>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  transition={{ "duration": 0.5, ease: "easeInOut" }}
                  className="div">
                  ...
                  <Card className="mb-4">
                    ...
                    <CardContent>
                      <Button className="relative hover:bg-white hover:text-black no-underline hover:tracking-wider px-4 py-3 hover:before:scale-x-75 before:scale-x-0 before:origin-center before:content-[''] before:absolute before:bottom-0 before:left-0 before:right-0 before:h-0.5 before:bg-black before:transition-transform before:duration-300 before:ease-linear"
          ...
          <motion.div
            ...
            {supportPage && (
              <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
                <h2 className="text-3xl font-bold text-center bg-[#252c42] rounded-xl p-2 text-white mb-6">Support Me</h2>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  transition={{ "duration": 0.5, ease: "easeInOut" }}
                  className="div">
